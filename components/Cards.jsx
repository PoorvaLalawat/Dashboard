                            ...
                            <table className="min-w-full">
                                ...
                                <tbody className="text-gray-600 text-sm font-light">
                                    ...
                                    <tr>
                                        ...
                                        <td className="py-3 px-6 text-center">
                                            <div className="flex item-center justify-center">
                                                <button classNameName='text-white h-10 px-4 bg-teal-400 hover:bg-teal-500 text-xs rounded justify-center'>View Offer</button>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td className="py-3 px-6 text-center">
                                            <div className="flex item-center justify-center">
                                                <button classNameName='text-white h-9 px-4 bg-teal-400 hover:bg-teal-500 text-xs rounded justify-center'>View Offer</button>
                                            </div>
                                        </td>
                                    </tr>
